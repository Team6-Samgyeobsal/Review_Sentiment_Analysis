...
train_data = pd.read_csv(
    filepath_or_buffer="filtering_model/data/train.csv", sep=",")
test_data = pd.read_csv(
    filepath_or_buffer="filtering_model/data/test.csv", sep=",")
...
# 생성한 단어 사전 저장
with open('filtering_model/tokenizer.pickle', 'wb') as f:
    pickle.dump(tokenizer, f, protocol=pickle.HIGHEST_PROTOCOL)

# 단어 사전 딕셔너리 저장
with open('filtering_model/word_index.pickle', 'wb') as f:
...
mc = ModelCheckpoint('filtering_model/best_model.h5', monitor='val_acc',
