...
train_data = pd.read_csv(
    filepath_or_buffer="sentimental_model/data/kakao_review_content2.csv", sep=",")
test_data = pd.read_csv(
    filepath_or_buffer="sentimental_model/data/kakao_review_content.csv", sep=",")
...
# 생성한 단어 사전 저장
with open('sentimental_model/tokenizer.pickle', 'wb') as f:
    pickle.dump(tokenizer, f, protocol=pickle.HIGHEST_PROTOCOL)

# 단어 사전 딕셔너리 저장
with open('sentimental_model/word_index.pickle', 'wb') as f:
...
mc = ModelCheckpoint('sentimental_model/best_model.h5', monitor='val_acc',
...
loaded_model = load_model('sentimental_model/best_model.h5')
